...
// import { refresh, refreshFail, refreshFailReset, refreshSuccess } from "../store/authentication/authentication.actions";
...
// 					} else {
// 						this.store.dispatch(refreshFail());
// 					}
//
// 					return throwError(errorResponse);
// 				}),
...
import { Router } from "@angular/router";
import { Store } from "@ngrx/store";
import { refreshFailReset, refreshSuccess } from "../store/authentication/authentication.actions";
import { ErrorNotificationService } from "../services/error-notification.service";
import { decreaseRequest, loadingOff } from "../store/loading/loading.actions";
