...
import io.spring.enrollmentsystem.feature.authentication.InvalidAccessTokenException;
import io.spring.enrollmentsystem.feature.authentication.InvalidRefreshTokenException;
...
public class GlobalExceptionHandler {
    ...
    public void handleInvalidAccessTokenException(HttpServletRequest request,
                                                  HttpServletResponse response,
                                                  InvalidAccessTokenException ex) throws Exception {
        handleExceptionInternal(request, response, HttpStatus.UNAUTHORIZED, ex);
    }
    ...
    public void handleInvalidRefreshTokenException(HttpServletRequest request,
                                                   HttpServletResponse response,
                                                   InvalidRefreshTokenException ex) throws Exception {
        handleExceptionInternal(request, response, HttpStatus.UNAUTHORIZED, ex);
    }
