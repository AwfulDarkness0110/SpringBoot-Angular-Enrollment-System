...
public class CourseController {
    ...
    @GetMapping("")
    @Operation(summary = "Find all instances of course as pages by predicate", tags = "course")
    @JsonView(BaseView.MediumWithId.class)
    ...
    @PostMapping("")
    @Operation(summary = "Add a new course", tags = "course")
    @JsonView(BaseView.MediumWithId.class)
    ...
    @PutMapping("/{courseId}")
    @Operation(summary = "Update a course by id", tags = "course")
    @JsonView(BaseView.MediumWithId.class)
    ...
    @Operation(summary = "Patch a course by id", tags = "course")
    @JsonView(BaseView.MediumWithId.class)
    ...
    @Operation(summary = "Delete a course by id", tags = "course")
